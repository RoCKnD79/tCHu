...
class GameStateTest {
    ...
    void gameStateWithCardDeckRecreatedIfNeededWorks() {
        ...
        for (int i = 0; i < INITIAL_CARD_DECK_SIZE; i++) {
            ...
            System.out.println("after withCardsDeckRecreatedIfNeeded: ");
            System.out.print(gameState.cardState().discardsSize() + ", ");
            System.out.println(gameState.cardState().deckSize());

            gameState = gameState.withoutTopCard();
            System.out.println("after withoutTopCard: ");
            System.out.print(gameState.cardState().discardsSize() + ", ");
            System.out.println(gameState.cardState().deckSize());

            gameState = gameState.withMoreDiscardedCards(SortedBag.of(topCard));
            System.out.println("after withMoreDiscardedCards: ");
            System.out.print(gameState.cardState().discardsSize() + ", ");
            System.out.println(gameState.cardState().deckSize());*/
